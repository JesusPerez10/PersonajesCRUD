...
namespace Wfdb
{
    public partial class Form1 : Form
    {
        ...
        {
            InitializeComponent();
            personaje = new PersonajeDB("localhost", "root", "37416689j");
        }
        ...
        private void buttonupdate_Click(object sender, EventArgs e)
        {
            ...
            string raza = textBoxRaza.Text;
            int nivelPoder = (int)numericUpDownNivelPoder.Value;
            string fechacreacion = textBoxFechaCreacion.Text;
            string historia = textBoxHistoria.Text;

            int respuesta = personaje.ActualizarPersonaje(nombre, raza, nivelPoder, fechacreacion, historia);
            if (respuesta > 0)
            {
